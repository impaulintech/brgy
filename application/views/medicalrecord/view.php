...
<link rel="stylesheet" href="<?= base_url('assets/css/bootstrap.css') ?>">
  ...
  <!-- <div class="align-items-center justify-content-between mb-4">
          ...
          <div class="container">
          <h1 class="h3 mb-0 text-gray-800 text-center">Medicalrecord</h1>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
             <div class="text-xs font-weight-bold  text-uppercase mb-1 ">Doctor's NAME <a style='margin-left: 1050px;' href="<?= site_url('medicalrecord') ?>"><img
...
<div class="row"><!-- Begin Row -->
  ...
  <!-- First Column -->
            <div class=" col-xl-12 col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold ">Details <a style='margin-left: 1050px;' href="<?= site_url('medicalrecord/show/'. $medicalrecord->id) ?>"><img
                             src="<?=base_url('assets/images/edit.png')?>" style="width:15px;" alt="edit"></a>
                    <!-- <?php echo "<a style='margin-left: 225px; text-decoration:none;' class='text-secondary' href='". base_url() ."medicalrecord/edit/". $medicalrecord->id ."'>" ?> 
           ...
           <?php if($this->session->flashdata('medicalrecord')): ?>  
          <?php echo "<div style='#1cc88a' class='alert alert-success alert-dismissible text-center'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h6><i class='con fa fa-check'></i></h6>".$this->session->flashdata('medicalrecord') ."</div>" ?>
           <?php endif; ?>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->id; ?></div>
               </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->FirstName; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->MiddleName; ?></div>
        </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->LastName; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Address; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Birthdate; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Age; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Sex; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Civil_Status; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->Contact_Num; ?></div>
         </div>
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $medicalrecord->AppointmentDate; ?></div>
         </div>
